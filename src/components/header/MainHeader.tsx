...
/**
 * Renders the main header of the application, displaying the app logo,
 * name, a settings icon, and a power button to toggle the app state.
 *
 * @param {() => void} togglePower - Callback function to handle the power button click
 */
export default function MainHeader({ togglePower }: MainHeaderProps) {
    ...
    <section className="header">
      ...
      <div className="header-right">
        ...
        <button onClick={togglePower}>
          <PowerIcon id="powerButton" className="icon-button power" />
        </button>
      </div>
    </section>
  );
